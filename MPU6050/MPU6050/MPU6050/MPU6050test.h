...
// Define registers per MPU6050test, Register Map and Descriptions, Rev 4.2, 08/19/2013 6 DOF Motion sensor fusion device
// Invensense Inc., www.invensense.com
// See also MPU-6050 Register Map and Descriptions, Revision 4.0, RM-MPU-6050A-00, 9/12/2012 for registers not listed in
// above document; the MPU6050test and MPU 9150 are virtually identical but the latter has an on-board magnetic sensor
//
...
#define WHO_AM_I_MPU6050test 0x75 // Should return 0x68

// Using the GY-521 breakout board, I set ADO to 0 by grounding through a 4k7 resistor
// Seven-bit device address is 110100 for ADO = 0 and 110101 for ADO = 1
#define ADO 0
#if ADO
#define MPU6050test_ADDRESS 0x69<<1  // Device address when ADO = 1
#else
#define MPU6050test_ADDRESS 0x68<<1  // Device address when ADO = 0
#endif
...
// Configure the motion detection control for low power accelerometer mode
    ...
    void resetMPU6050test() ;

    void initMPU6050test();
    void calibrateMPU6050test(float * dest1, float * dest2);
// Accelerometer and gyroscope self test; check calibration wrt factory settings
    void MPU6050testSelfTest(float * destination);
...
// but is much less computationally intensive---it can be performed on a 3.3 V Pro Mini operating at 8 MHz!
    ...
    int lastUpdate, firstUpdate;     // used to calculate integration interval                               // used to calculate integration interval
