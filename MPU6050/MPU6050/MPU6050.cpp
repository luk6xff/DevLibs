...
void MPU6050::writeByte(uint8_t address, uint8_t regAddress, uint8_t data)
{
    i2cDrv.write(address,regAddress,1, &data);
}

uint8_t MPU6050::readByte(uint8_t address, uint8_t regAddress)
{
    uint8_t data[1]; 
...
void MPU6050::readBytes(uint8_t address, uint8_t regAddress, uint8_t count, uint8_t * dest)
{
...
void MPU6050::initHelperVariables()
{
